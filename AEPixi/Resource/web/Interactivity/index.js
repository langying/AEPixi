...
// create a background...
var background = PIXI.Sprite.fromImage('button_test_BG.png');
...
buttons[0].scale = new PIXI.Point(1.2, 1.2);

buttons[2].rotation = Math.PI / 10;

buttons[3].scale = new PIXI.Point(0.8, 0.8);

buttons[4].scale = new PIXI.Point(0.8,1.2);
